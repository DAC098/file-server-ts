...
export default class file_handles extends Extension {
    ...
    async handle_root_redirect(request: route_request, response: Http2ServerResponse): Promise<void|boolean> {
    ...
    async handle_post_file(request: route_request, response: Http2ServerResponse): Promise<void> {
    ...
    async handle_get_file(request: route_request, response: Http2ServerResponse): Promise<void> {
    ...
    async handle_delete_file(request: route_request, response: Http2ServerResponse): Promise<void> {
        let path = '/' + request.params['path'];
        let full_path = join(this.search_path,path);
        let stats: Stats = null;
    ...
    async load(server: Server): Promise<void> {        
        server.router.addMdlwr(
            ...
            '/',
            {},
            (req, res) => this.handle_root_redirect(req, res)
        );
        ...
        server.router.addRoute(
            ...
            '/fs/:path*',
            {},
            (req, res) => this.handle_get_file(req, res)
        );
        ...
        server.router.addRoute(
            ...
            '/fs/:path*',
            {},
            (req, res) => this.handle_post_file(req, res)
        );
        ...
        server.router.addRoute(
            ...
            '/fs/:path*',
            {},
            (req, res) => this.handle_delete_file(req, res)
        );
